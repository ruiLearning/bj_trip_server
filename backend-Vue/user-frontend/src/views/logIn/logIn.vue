      ...
      <div style="flex: 1;width: 100%;padding: 40px;display: flex;flex-direction: column;justify-content: center;" >
        ...
        <el-form :model="form" :rules="rules" ref="formRef">
          ...
          <div style="display: flex">
            <el-button style="width: 100%; background-color: #3c81ff;  color: white;flex: 4" @click="login">登 录</el-button>
            <el-button style="width: 100%; background-color: #16ad05;  color: white;flex: 4" @click="toRegister">注册</el-button>
<!--            <el-button style="width: 100%; background-color: #de8602;  color: white;flex: 4" @click="toForget">忘记密码</el-button>-->
          </div>
...
<!--    忘记密码-->
    <el-dialog title="找回密码" :visible.sync="dialogVisible1" width="100%" :before-close="handleClose">
      <div style="display: flex; flex-direction: column; gap: 20px;" >
        ...
        <el-button  @click="getEmailReg" style="  color: #fff; text-align: center;background-color: #3E78F3;">
          获取验证码
        </el-button>
      </div>
      <span slot="footer" class="dialog-footer">
...
<script>
import {login, getUser, saveUser, forgetPassword, getEmailReg} from '../../api/api'
  export default {
    data() {
      return{
        loginAccount: "",
